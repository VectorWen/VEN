...
public class RefreshListView extends ListView implements OnScrollListener,
	...
	private void initHeadView(Context context) {
		mHeadView = LayoutInflater.from(context).inflate(
				R.layout.head_refresh_list, null);
		mTextViewRefresh = (TextView) mHeadView
				.findViewById(R.id.head_tipsTextView__refresh_list);
	...
	private void initLoadMoreView(Context context) {
		mFootView = LayoutInflater.from(context).inflate(
				R.layout.footer_refresh_list, null);

		mFootLoadedMoreView = mFootView.findViewById(R.id.item_footer_ll_more);
		mFootLoadedMoreView.setOnClickListener(this);

		mFootLoadingMoreView = mFootView
				.findViewById(R.id.item_footer_ll_refresh);

		mLoadingMorePB = (ProgressBar) mFootView
				.findViewById(R.id.item_footer_pb_refresh);

		mLoadMoreTextView = (TextView) mFootView
				.findViewById(R.id.item_footer_tv_refresh);
